...
from src.controller.simulator import simulate
from src.io.reportWriter import buildReport
...
def run(input_path: str, output_path: str) -> None:
    ...
    - Bước 2: Chạy mô phỏng lập lịch (simulation)
    ...
    segments, processes = simulate(queues, processes)
